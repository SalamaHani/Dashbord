        ...
        <div className="rounded-2xl border border-gray-200 bg-white px-5  pt-5 pb-0 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6 ">
          <div className="px-2 pr-14">
            ...
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
              Add your details to keep your profile up-to-date.
            </p>
          </div>
                    ...
                    <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                      <div className="">
                        ...
                        <label
                          ...
                          class="inline-flex items-center justify-between w-full p-3 bg-white dark:bg-gray-800   dark:hover:border-brand-500 rounded-lg border border-dashed cursor-pointer group border-neutral-200/70 text-gray-400 peer-checked:border-blue-400 peer-checked:text-neutral-900 peer-checked:bg-blue-200/50 hover:text-neutral-900 hover:border-success/50"
                        >
