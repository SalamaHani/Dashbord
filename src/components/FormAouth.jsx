        ...
        <div>
          ...
          <div>
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
              <button
                className="inline-flex items-center dark:hover:text-gray-400 justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10"
                fdprocessedid="8feol6"
              >
                <svg
                  width="20"
                  height="20"
              ...
              <button className="inline-flex items-center dark:hover:text-gray-400 justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10">
                <svg
                  width="21"
                  ...
                  >
                    <div className="relative">
                      <input
                        ...
                        className="sr-only"
                      />
                      <div className="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] bg-transparent border-gray-300 dark:border-gray-700">
