...
function CartStata() {
  const HTMLContent = (cont) => {
    const count = useMotionValue(0);
    const rounded = useTransform(() => Math.round(count.get()));

    useEffect(() => {
      const controls = animate(count, cont, { duration: 10 });
    ...
    return (
      <motion.pre
        className="dark:text-white font-bold text-gray-950"
        style={text}
      >
        {rounded}
      </motion.pre>
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 md:gap-6">
        <div className="rounded-2xl border h-50  border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
          ...
          <div className="mt-5 flex items-end justify-between">
            ...
            <span className="flex items-center gap-1 rounded-full bg-success/25 dark:text-white  py-0.5 pl-2 pr-2.5 text-sm font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
              <svg
        ...
        <div className="rounded-2xl border h-50  border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
          ...
          <div className="mt-5 flex items-end justify-between">
            ...
            <span className="flex items-center gap-1 rounded-full bg-error/25 dark:text-white py-0.5 pl-2 pr-2.5 text-sm font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500">
              <svg
                className="fill-current "
                width="12"
                height="12"
        ...
        <div className="rounded-2xl border h-50  border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
          ...
          <div className="mt-5 flex items-end justify-between">
            ...
            <span className="flex items-center gap-1 rounded-full dark:text-white  bg-success/25 py-0.5 pl-2 pr-2.5 text-sm font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500">
              <svg
                className="fill-current "
                width="12"
                height="12"
