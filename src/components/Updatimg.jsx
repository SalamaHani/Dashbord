    ...
    <>
      <div className="rounded-2xl border border-gray-200 bg-white px-2 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-2 sm:pt-6">
        ...
        <div className="space-y-6 border-t border-gray-100  sm:p-6 dark:border-gray-800">
          ...
          {errorse.image != null ? (
            <span className="text-sm text-error/75 ">{errorse.image[0]}</span>
          ) : (
          ...
          {image == null ? null : (
            <div className=" w-full relative rounded-lg bg-brand-100">
              <TiDeleteOutline
                onClick={handeldelet}
                className="absolute left-[-8px] top-[-7px] text-xl "
              />
              <img
                className=" w-20 h-20 rounded-lg bg-brand-100"
                src={image}
                alt=""
              />
            </div>
